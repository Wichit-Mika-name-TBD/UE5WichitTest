...
GAMEPROJECTFILE =/home/mika/prj/UE5WichitTest/UE5WichitTest.uproject

TARGETS = \
	UE5WichitTest-Linux-Debug  \
	UE5WichitTest-Linux-DebugGame  \
	UE5WichitTest-Linux-Test  \
	UE5WichitTest-Linux-Shipping  \
	UE5WichitTest \
	UE5WichitTestEditor-Linux-Debug  \
	UE5WichitTestEditor-Linux-DebugGame  \
	UE5WichitTestEditor-Linux-Test  \
	UE5WichitTestEditor-Linux-Shipping  \
	UE5WichitTestEditor \
...
UE5WichitTest-Linux-Debug:
	 $(PROJECTBUILD) UE5WichitTest Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTest-Linux-DebugGame:
	 $(PROJECTBUILD) UE5WichitTest Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTest-Linux-Test:
	 $(PROJECTBUILD) UE5WichitTest Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTest-Linux-Shipping:
	 $(PROJECTBUILD) UE5WichitTest Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTest:
	 $(PROJECTBUILD) UE5WichitTest Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTestEditor-Linux-Debug:
	 $(PROJECTBUILD) UE5WichitTestEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTestEditor-Linux-DebugGame:
	 $(PROJECTBUILD) UE5WichitTestEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTestEditor-Linux-Test:
	 $(PROJECTBUILD) UE5WichitTestEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTestEditor-Linux-Shipping:
	 $(PROJECTBUILD) UE5WichitTestEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE5WichitTestEditor:
	 $(PROJECTBUILD) UE5WichitTestEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
